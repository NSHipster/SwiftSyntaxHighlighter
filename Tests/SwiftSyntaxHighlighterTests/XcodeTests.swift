...
final class XcodeTests: XCTestCase {
    func testExample() throws {
        ...
        let actual = try highlight(source, using: Xcode.self)
        ...
        <span class="keyword">func</span> <span class="function">greet</span>(<span class="variable">name</span>: <span class="type">String</span>) -&gt; <span class="type">String</span> {
            <span class="keyword">return</span> <span class="string literal">&quot;</span><span class="string literal">Hello, </span>\(<span class="variable">name</span>)<span class="string literal">!</span><span class="string literal">&quot;</span> <span class="comment">// &#x1F44B;</span>
        }</code></pre>
        """#
